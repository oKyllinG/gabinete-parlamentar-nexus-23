...
const MunicipioBriefing = () => {
  ...
  return <div className="min-h-screen bg-background">
      <div className="p-6">
        ...
        <BriefingLayout municipio={municipio} dadosPoliticos={dadosPoliticos} deputadosFederais={deputadosFederais} deputadosEstaduais={deputadosEstaduais} liderancas={liderancas} historicoAcoes={historicoAcoes} onSaveDadosPoliticos={handleSaveDadosPoliticos} onSaveDeputadosFederais={handleSaveDeputadosFederais} onSaveDeputadosEstaduais={handleSaveDeputadosEstaduais} onSaveLiderancas={handleSaveLiderancas} onSaveHistoricoAcoes={handleSaveHistoricoAcoes} />
      </div>
    </div>;
};
